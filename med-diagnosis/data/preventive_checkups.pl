...
preventive_examinations(migraine, [sumatriptan_imitrex], examination_for_serotonin_syndrome).
...
preventive_examinations(multiple_sclerosis, [interferon_beta_1a_avonex], examination_for_liver_damadge).
...
preventive_examinations(multiple_sclerosis, [natalizumab_tysabri], examination_for_multifocal_leukoencephalopathy).
...
preventive_examinations(alzheimer_disease, [donepezil_aricept, rivastigmine_exelon, galantamine], examination_for_cardiac_arrhythmia).
...
preventive_examinations(epilepsy, [levetiracetam_keppra, phenytoin_dilantin, lamotrigine_lamictal, divalproex_sodium_depakote, carbamazepine, topiramate_topamax, phenobarbital, zonisamide, valproic_acid, fosphenytoin, ethosuximide, lacosamide_vimpat], examination_for_liver_inflamamation).
